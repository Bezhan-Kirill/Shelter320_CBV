...
from users.views import user_generate_new_password, UserRegisterView, UserListView, \
    UserLoginView, UserProfileView, UserUpdateView, UserPasswordChangeView, UserLogoutView, UserViewProfileView
